    ...
    <Section id="services">
      <div className='title'>
        ...
        <p>
          ...
          ab ut sed quaerat alias temporibus eos ad voluptatibus culpa?
        </p>
      </div>
      <div className='services'>
        <div className='service'>
          <img src={Services2} alt="ServiceImage" />
          <p>
        ...
        <div className='service yellow'>
          <img src={Services1} alt="ServiceImage" />
          <p>
            He Printing and Typesetting the industry. <span>Lorem Ipsum</span>{" "}
            has been the Industry's
          </p>
        ...
        <div className='service'>
          <img src={Services3} alt="ServiceImage" />
          <p>
            He Printing and Typesetting the industry. <span>Lorem Ipsum</span>{" "}
            has been the Industry's
          </p>
